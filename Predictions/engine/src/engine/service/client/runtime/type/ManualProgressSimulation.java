...
public class ManualProgressSimulation implements RuntimeRequest {
    private EngineService engine;

    public ManualProgressSimulation() {
    }

    public ManualProgressSimulation(EngineService engine) {
        this.engine = engine;
    }
    ...
    public Object generateResponse(Object... args) {
        ...
        optionalSimulation.ifPresent(Simulation::requestManualProgress);
        return true;
    }
}
