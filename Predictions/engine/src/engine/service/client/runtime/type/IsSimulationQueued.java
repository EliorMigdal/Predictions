...
public class IsSimulationQueued implements RuntimeRequest {
    private EngineService engine;

    public IsSimulationQueued() {
    }

    public IsSimulationQueued(EngineService engine) {
        this.engine = engine;
    }
    ...
    public Object generateResponse(Object... args) {
        ...
        return optionalSimulation.map(Simulation::getQueueStatus).orElse(null);
    }
}
