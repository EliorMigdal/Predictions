...
public class IsSimulationPaused implements RuntimeRequest {
    private EngineService engine;

    public IsSimulationPaused() {
    }

    public IsSimulationPaused(EngineService engine) {
        this.engine = engine;
    }
    ...
    public Object generateResponse(Object... args) {
        ...
        return optionalSimulation.map(Simulation::getPauseStatus).orElse(null);
    }
}
