...
public class ApproveClientRequest implements Request {
    private final String clientName;
    private final String requestID;

    public ApproveClientRequest(String clientName, String requestID) {
    ...
    public Object POST() {
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            URI url = new URIBuilder(DomainUrl.DOMAIN_URL.getUrl() + "/approveClientRequest").build();
