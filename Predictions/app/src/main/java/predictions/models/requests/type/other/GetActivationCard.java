...
public class GetActivationCard implements Request {
    private final String simulationName;
    private final String endpoint;
    private final String ruleName;
    private final String activationName;

    public GetActivationCard(String simulationName, String endpoint, String ruleName, String activationName) {
    ...
    public Object GET() {
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            uriBuilder.addParameter("activation", this.activationName);
