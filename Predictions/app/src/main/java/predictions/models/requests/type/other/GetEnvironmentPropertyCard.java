...
public class GetEnvironmentPropertyCard implements Request {
    private final String simulationName;
    private final String environmentName;
    private final String endpoint;

    public GetEnvironmentPropertyCard(String simulationName, String environmentName, String endpoint) {
    ...
    public Object GET() {
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            uriBuilder.addParameter("environment", this.environmentName);
