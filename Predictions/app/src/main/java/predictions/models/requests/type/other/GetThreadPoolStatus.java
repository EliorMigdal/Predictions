...
public class GetThreadPoolStatus implements Request {
    private final String endpoint;

    public GetThreadPoolStatus(String endpoint) {
    ...
    public Object GET() {
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            if (jsonResponse.isEmpty()) {
                ...
                Type arrayType = new TypeToken<ThreadPoolStatusResponseDTO>(){}.getType();
