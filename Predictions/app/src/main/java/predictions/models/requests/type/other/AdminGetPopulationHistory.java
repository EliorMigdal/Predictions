...
public class AdminGetPopulationHistory implements Request {
    private final String clientName;
    private final String requestID;
    private final String simulationName;
    private final String simulationID;

    public AdminGetPopulationHistory(String clientName, String requestID, String simulationName, String simulationID) {
    ...
    public Object GET() {
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            if (jsonResponse.isEmpty()) {
                ...
                Type arrayType = new TypeToken<ArrayList<PopulationResultsResponseDTO>>(){}.getType();
